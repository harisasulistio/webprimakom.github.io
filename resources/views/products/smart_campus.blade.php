...
<section class="section is-sm section-about">
    <div class="container">
        {{--<h2 class="section-title mt-5">Smart Campus<span class="text-primary">. </span></h2>--}}
        ...
        <div class="row flex vcenter pt-5 mt-5">
            <div class="col-lg-8" data-aos="fade-left" data-aos-delay="200">
                ...
                <div class="section-body">
                    <p class="section-desc">Sistem pembelajaran online yang mulai banyak di aplikasikan dalam dunia pendidikan membuat sistem daring menjadi lebih aktif.</p>
                    <p class="section-desc">Kita membangun sebuah platform yang mampu mengintegrasikan beberapa aplikasi untuk memudahkan sistem pembelajaran dalam jaringan.</p>
			...
			<div class="col-lg-4" data-aos="fade-left" data-aos-delay="200">
                <img class="about-img" src="{{URL::to('/assets_web/produk/smart_campus.JPG')}}" alt="">
            </div>
		</div>
<!-- LMS -->
		<div class="row flex vcenter justify-content-center pt-5 mt-5">
            <div class="col-12">
				<div class="section-head" data-aos="fade-up" data-aos-delay="200">
					<h2 class="section-title">Kelebihan Aplikasi LMS<span class="text-primary">. </span></h2>
				</div>
                {{--<div class="section-body">
			...
			<div class="col-lg-9" data-aos="fade-up" data-aos-delay="300">
                <img class="about-img" src="{{URL::to('/assets_web/produk/kelebihan_lms.JPG')}}" alt="">
            </div>
            <!-- <div class="col-lg-12">
                <div class="section-body">
		...
		<div class="row flex vcenter pt-5 mt-5">
            <div class="col-lg-8" data-aos="fade-left" data-aos-delay="200">
				<div class="section-head">
					<h2 class="section-title">Fitur dan Layanan Aplikasi<span class="text-primary">. </span></h2>
				</div>
                <p class="section-subtitle font-weight-bold mt-2">LMS (Learning Management System)</p>
                <div class="col-lg-9" data-aos="fade-up" data-aos-delay="300">
                    <img class="about-img" src="{{URL::to('/assets_web/produk/Fitur_lms.JPG')}}" alt="">
                </div>
                <p class="section-subtitle font-weight-bold mt-2">PKG Berbasis Kebutuhan Siswa</p>
                <div class="col-lg-9" data-aos="fade-up" data-aos-delay="300">
                    <img class="about-img" src="{{URL::to('/assets_web/produk/Fitur_dan_Layanan_aplikasi.JPG')}}" alt="">
                </div>
                <!-- <div class="section-body">
...
<!-- Tracer Study -->
    <div class="row flex vcenter justify-content-center pt-5 mt-5">
            <div class="col-12">
                <div class="section-head">
					<h2 class="section-title">Kelebihan Aplikasi Tracer Study<span class="text-primary">. </span></h2>
				</div>
				<!-- <div class="section-head" data-aos="fade-up" data-aos-delay="200">
					<h2 class="section-title">Kelebihan Aplikasi Tracer Study<span class="text-primary">. </span></h2>
				</div> -->
			...
			<div class="col-lg-9" data-aos="fade-up" data-aos-delay="300">
                <img class="about-img" src="{{URL::to('/assets_web/produk/Kelebihan_tracer _study.JPG')}}" alt="">
            </div>
            <!-- <div class="col-lg-12">
                <div class="section-body">
				<p class="section-subtitle font-weight-bold mt-2">Customizing</p>
		...
		<div class="row flex vcenter pt-5 mt-5">
            <div class="col-lg-8" data-aos="fade-left" data-aos-delay="200">
                ...
                <p class="section-subtitle font-weight-bold mt-2">Tracer Study</p>
                <div class="col-lg-9" data-aos="fade-up" data-aos-delay="300">
                    <img class="about-img" src="{{URL::to('/assets_web/produk/Fitur_tracer_study.JPG')}}" alt="">
                </div>
                <p class="section-subtitle font-weight-bold mt-2">Tampilan Tracer Study</p>
                <div class="col-lg-9" data-aos="fade-up" data-aos-delay="300">
                    <img class="about-img" src="{{URL::to('/assets_web/produk/tampilan_trace_rstudy.JPG')}}" alt="">
                </div>
                <!-- <div class="section-body">
                    <p class="section-desc">1. Bisa melakukan kustomisasi.<br> 2. Keamanan data yang lebih aman.<br>3. Nama domain gratis.<br>4. Hingga 500 pengguna bersamaan.<br>5. Terdapat fitur Pesan dalam pertemuan tersebut.<br>6. Cloud Storage.<br>7. Terdapat Manajemen rekaman.<br>8. Bisa login dengan akun Google.<br>9. Mudah digunakan semudah Anda menjelajah browser.</p>
                </div> -->
...
<!-- SIAKAD -->
    <div class="row flex vcenter justify-content-center pt-5 mt-5">
            ...
            <div class="row flex vcenter pt-5 mt-5">
                <div class="col-lg-8" data-aos="fade-left" data-aos-delay="200">
                    <div class="section-head" data-aos="fade-up" data-aos-delay="200">
                        <h2 class="section-title">Siakad<span class="text-primary">. </span></h2>
                    </div>
                    <div class="section-body">
                        <p class="section-desc">SIAKAD (Sistem Informasi Akademik) adalah suatu sistem informasi yang dibangun untuk memberikan kemudahan kepada pengguna dalam kegiatan administrasi akademik kampus secara online.</p>
                        <!-- <p class="section-desc">Kita membangun sebuah platform yang mampu mengintegrasikan beberapa aplikasi untuk memudahkan sistem pembelajaran dalam jaringan.</p> -->
                        <!-- <p class="section-desc">Fitur Prima Meet :<br>1. Personalized Room<br>2. Recording Management<br>3. Custom Design<br>4. User Authentication</p> -->
                    </div>
                </div>
                <div class="col-lg-4" data-aos="fade-left" data-aos-delay="300">
                    <img class="about-img" src="{{URL::to('/assets_web/produk/siakad.JPG')}}" alt="">
                </div>
		    </div>

				<div class="section-head" data-aos="fade-up" data-aos-delay="200">
					<h2 class="section-title">Kelebihan Aplikasi Siakad<span class="text-primary">. </span></h2>
				</div>
                {{--<div class="section-body">
                    <p class="section-desc">Layanan Meeting melalui virtual yang diberikan secara gratis kepada pelanggan PT Prima Mandiri Komunikasi didalam upaya meningkatkan koordinasi dan efektif untuk menekan waktu koordinasi.</p>
                    <p class="section-desc"></p>
			...
			<div class="col-lg-9" data-aos="fade-up" data-aos-delay="300">
                <img class="about-img" src="{{URL::to('/assets_web/produk/kelebihan_siakad.JPG')}}" alt="">
            </div>
            <!-- <div class="col-lg-12">
                <div class="section-body">
				<p class="section-subtitle font-weight-bold mt-2">Customizing</p>
		...
		<div class="row flex vcenter pt-5 mt-5">
            <div class="col-lg-8" data-aos="fade-left" data-aos-delay="200">
                ...
                <p class="section-subtitle font-weight-bold mt-2">Siakad</p>
                <div class="col-lg-9" data-aos="fade-up" data-aos-delay="300">
                    <img class="about-img" src="{{URL::to('/assets_web/produk/Fitur_dan_Layanan_siakad.JPG')}}" alt="">
                </div>
                <p class="section-subtitle font-weight-bold mt-2">Tampilan Siakad</p>
                <div class="col-lg-9" data-aos="fade-up" data-aos-delay="300">
                    <img class="about-img" src="{{URL::to('/assets_web/produk/Tampilan_siakad.JPG')}}" alt="">
                </div>
                <!-- <div class="section-body">
                    <p class="section-desc">1. Bisa melakukan kustomisasi.<br> 2. Keamanan data yang lebih aman.<br>3. Nama domain gratis.<br>4. Hingga 500 pengguna bersamaan.<br>5. Terdapat fitur Pesan dalam pertemuan tersebut.<br>6. Cloud Storage.<br>7. Terdapat Manajemen rekaman.<br>8. Bisa login dengan akun Google.<br>9. Mudah digunakan semudah Anda menjelajah browser.</p>
                </div> -->
