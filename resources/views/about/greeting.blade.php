...
<section class="section is-sm section-about">
    <div class="container">
        <h2 class="section-title" data-aos="fade-up" data-aos-delay="200">GREETING</h2>
        <hr/>
...
<section class="section is-sm section-grey">
        <div class="container">
            ...
            <div class="section-head flex between vcenter wrap" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="box has-shadow has-left-icon">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <p class="box-desc">Jalan Semeru Raya No. D-1 Kelurahan Sumbersari, Kecamatan Sumbersari, Jember 68121
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="box has-shadow has-left-icon">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <p class="box-desc">Komplek perumahan pagutan ragency, tahap V No. 7, Mataram Pagutan<br/><br/>
                                    </p>
                                </div>
                            </div>
