		...
		<div class="row align-items-center">
			<div class="col-lg-12">
				<div class="section-head mb-lg-0">
					...
					<h2 class="section-title"  data-aos="fade-up" data-aos-delay="300">Our Vision<span class="text-primary">. </span></h2>
					<p class="section-desc mb-lg-0" data-aos="fade-up" data-aos-delay="300">Menjadi perusahaan yang	kompetitif dan unggul di bidang Teknologi Informasi dan Komunikasi.
					</p>
					<p class="section-desc mb-lg-0" data-aos="fade-up" data-aos-delay="300">Konsisten dengan kualitas kerja maksimal untuk mencapai kepuasan pelanggan secara berkelanjutan.
					</p>
					<h2 class="section-title mt-5" data-aos="fade-up" data-aos-delay="300">Our Mision<span class="text-primary">. </span></h2>
					<p class="section-desc mb-lg-0" data-aos="fade-up" data-aos-delay="300">Memberikan layanan maksimal di bidang TIK.
					</p>
					<p class="section-desc mb-lg-0" data-aos="fade-up" data-aos-delay="300"> Menjadi mitra yang handal bersinergi satu dengan yang lain untuk memberikan dampak yang signifikan bagi pengambangan bisnis
					</p>
					<p class="section-desc mb-lg-0" data-aos="fade-up" data-aos-delay="300"> Fokus menyediakan SDM yang Berkualitas dan berintegritas</p>
