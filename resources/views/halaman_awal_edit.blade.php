...
@section('content')
            ...
            <div class="row flex vcenter px-5">
                <div class="col-lg-6" data-aos="fade-right" data-aos-delay="500">
                    <div class="section-head mb-lg-0">
                        ...
                        <p class="section-desc">PT Prima Mandiri Komunikasi is a company engaged in the supply of pieces of
                            equipment and services for Electronic Mechanical Equipment, and Telecmunications. Primakom is
                            supported by a responsible expert and has to commitment at work to produce the maximum results
                        </p>
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="500">
                    ...
                    <img class="section-shape1"
                        src="https://digikit.netlify.app/assets/images/others/shape-illustration-grad.svg" alt="">
        ...
        <div class="container">
            <div class="section-head" data-aos="fade-down" data-aos-delay="300">
                ...
                <p class="section-description is-center  ml-auto mr-auto mt-20">
                    We understand the importance of approaching each work integrally and believe in the power of simple and
                    easy communication.
                </p>
            </div>
            <div class="card-deck" data-aos="fade-up" data-aos-delay="500">
                <div class="col-md-4">
                    <div class="card shadow mb-5">
                        <div class="banner"
                            style="background-image: url('{{ URL::to('assets_web/logo/new_logo/S3.png') }}');background-size:contain;">
                        </div>
                        {{-- <div class="menu">
                        ...
                        <div class="desc">
                            Solusi pengamanan dan pengawasan asset perusahaan, meliputi: CCTV Industrial, RFID, AI, Gate
                            Automation, Flap Barier dll.
                        </div>
                        <div class="actions">
                ...
                <div class="col-md-4">
                    <div class="card shadow">
                        <div class="banner"
                            style="background-image: url('{{ URL::to('assets_web/logo/new_logo/IT.png') }}');background-size:contain;">
                        </div>
                        {{-- <div class="menu">
                        ...
                        <div class="desc">
                            Solusi layanan infrastruktur IT dengan mempertahankan dan mengantisipasi kebutuhan rangkaian
                            proses dan fungsi.
                        </div>
                        <div class="actions">
                            <div class="follow-btn text-center">
                ...
                <div class="col-md-4">
                    <div class="card shadow">
                        <div class="banner"
                            style="background-image: url('{{ URL::to('assets_web/logo/new_logo/primavillage.png') }}');background-size:contain;">
                        </div>
                        {{-- <div class="menu">
							<div><span></span><span></span><span></span></div>
						</div> --}}
                        ...
                        <div class="desc">
                            Digitalisasi Pengelolaan kebutuhan Masyarakat Desa oleh Badan Usaha Milik Desa dan Layanan Desa
                            Mandiri menghadapi era Revolusi Industri 4.0.
                        </div>
                        <div class="actions">
                            <div class="follow-btn text-center">
                ...
                <div class="col-md-4">
                    <div class="card shadow">
                        <div class="banner"
                            style="background-image: url('{{ URL::to('assets_web/logo/new_logo/primaschool.png') }}');background-size:contain;">
                        </div>
                        {{-- <div class="menu">
							<div><span></span><span></span><span></span></div>
						</div> --}}
                        ...
                        <div class="desc">
                            Platform sistem pembelajaran online yang dapat terintegrasi dengan beberapa fungsi layanan yang
                            terdiri dari E-learning, Siakad, Tracer Study dan Virtual Class.
                        </div>
                        <div class="actions">
                            <div class="follow-btn text-center">
                ...
                <div class="col-md-4">
                    <div class="card shadow">
                        <div class="banner"
                            style="background-image: url('{{ URL::to('assets_web/logo/new_logo/primameet.png') }}');background-size:contain;background-position:center;">
                        </div>
                        {{-- <div class="menu">
							<div><span></span><span></span><span></span></div>
						</div> --}}
                        ...
                        <div class="desc">
                            Layanan Meeting virtual yang diberikan dalam upaya meningkatkan koordinasi dan efektifitas
                            kinerja meeting tanpa bertemu secara langsung.
                        </div>
                        <div class="actions">
                            <div class="follow-btn text-center">
                ...
                <div class="col-md-4">
                    <div class="card shadow">
                        <div class="banner"
                            style="background-image: url('{{ URL::to('assets_web/logo/new_logo/PDS.png') }}'); background-size:contain;background-position: center;">
                        </div>
                        {{-- <div class="menu">
								<div><span></span><span></span><span></span></div>
							</div> --}}
                        ...
                        <div class="desc">
                            Solusi dalam pembuatan dan pengembangan software atau aplikasi yang digunakan untuk menunjang
                            produktivitas berbagai instansi dan perusahaan.
                        </div>
                        <div class="actions">
                            <div class="follow-btn text-center">
                                <a href="{{ URL::to('/products/prima-development') }}"
                                    class="myButton col-md-12">Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card shadow">
                        <div class="banner"
                            style="background-image: url('{{ URL::to('assets_web/logo/new_logo/logo_smartcampus.JPG') }}'); background-size:contain;background-position: center;">
                        </div>
                        {{-- <div class="menu">
								<div><span></span><span></span><span></span></div>
							</div> --}}
                        ...
                        <div class="desc">
                            Sistem pembelajaran online yang mulai banyak di aplikasikan dalam dunia pendidikan membuat
                            sistem daring menjadi lebih aktif. Kita membangun sebuah platform yang mampu mengintegrasikan
                            beberapa aplikasi untuk memudahkan sistem pembelajaran dalam jaringan.
                        </div>
                        <div class="actions">
                            <div class="follow-btn text-center">
                    ...
                    <div class="">
                        <div class="post-wrap mt-0">
                            <a href="{{ url('/blog/' . $data->slug) }}">
                                <div class="post-img">
                                    <img src="{{ asset('storage/featured_images/' . $data->featured_images) }}" alt=""
                                        style="height:230px;width:100%;">
                                </div>
                            </a>
                            <div class="post-content mb-0">
                                <div class="post-meta">
                                    <div class="post-tag"> <span class="tag-item">{{ $data->category->category }}</span>
                                    </div>
                                </div>
                                <h3 class="post-title"><a href="{{ url('/blog/' . $data->slug) }}"
                                        class="hover-blue">{{ Str::limit(strip_tags($data->title), $limit = 50, $end = '...') }}
                                    </a>
                                </h3>
                                <p class="desc-blog">
                                    {!! Str::limit(strip_tags($data->article), $limit = 100, $end = '...') !!}
                                </p>
                                <span class="post-author">By <a href="#" class="text-blue" rel="author">Admin
                                        Primakom</a></span>
    ...
    <section class="section is-sm is-center section-price ml-md-5">
        <div class="container">
            <div class="row" data-aos="fade-down" data-aos-delay="300">
                <div class="col">
                    <h2 class="section-title is-center">HyperCloud by Primakom</h2>
                    <p class="section-description is-center ml-auto mr-auto mt-20">Cloud Service yang dapat di sesuaikan
            ...
            <div class="row mt-5">
                <div class="col-md-4">
                    <div class="card shadow-sm mb-4" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="100">
                        <div class="card-header text-white">
                            <div class="name text-center mt-3">HYPERCLOUD SILVER</div>
                            <div class="subtitle text-center mb-3">(Virtual Machine & Website)</div>
                        </div>
                        <div class="card-body">
                            <div class="fitur-list">
                                <ul class="lits-item">
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i>Gratis pembuatan dan
                                        konsultasi website dengan google analytic</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i>Gratis domain
                                        termasuk SSL</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i>Gratis domain
                                        termasuk SSL</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i>1 IP Public</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i> 4 vCPU</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i> 4 GB Memory</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i> 50 GB Storage</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i> Minimal Kontrak 1
                                        tahun</li>
                                </ul>
                                <div class="price text-center mt-3">
                                    <s>
                                        <p class="price-normal">Rp 1,5 JT</p>
                                    </s>
                                    <h4 class="promo text-blue">Rp. 1.040.000</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card shadow-lg mb-4" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="200">
                        <div class="card-header text-white">
                            <div class="name text-center mt-3">HYPERCLOUD GOLD</div>
                            <div class="subtitle text-center mb-3">(Virtual Machine & Mail server)</div>
                        </div>
                        <div class="card-body">
                            <div class="fitur-list">
                                <ul class="lits-item">
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-primary"></i>Gratis set up
                                        Zimbra
                                        dan mail Server</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-primary"></i>Gratis domain
                                        termasuk SSL</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-primary"></i>Gratis support
                                        sysadmin enginner
                                        24x7 jam</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-primary"></i>1 IP Public</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-primary"></i>4 vCPU</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-primary"></i> 4 GB Memory</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-primary"></i> 50 GB Storage
                                    </li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-primary"></i> Minimal Kontrak 1
                                        tahun</li>
                                </ul>
                                <div class="free-up text-center">
                                    <h5 class="title text-center text-primary">FREE UP TO</h5>
                                    <p class="text-center mt-0">+50 GB Storage</p>
                                </div>
                                <div class="price text-center mt-3">
                                    <s>
                                        <p class="price-normal">Rp 2 JT</p>
                                    </s>
                                    <h4 class="promo text-primary">Rp. 1.350.000</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="300">
                        <div class="card-header text-white">
                            <div class="name text-center mt-3">HYPERCLOUD PLATINUM</div>
                            <div class="subtitle text-center mb-3">(Virtual Machine, Website
                                dan Mail Server)</div>
                        </div>
                        <div class="card-body">
                            <div class="fitur-list">
                                <ul class="lits-item">
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i>Gratis pembuatan dan
                                        konsultasi
                                        website dengan google analytic</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i>Gratis set up Zimbra
                                        Mail Server</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i>Gratis domain
                                        termasuk SSL</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i>Gratis support
                                        sysadmin enginner
                                        24x7 jam</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i>1 IP Public</li>
                                    <li class="mb-3"><i class="far fa-check-circle mr-2 text-blue"></i> 4 GB Memory</li>
                                ...
                                <div class="free-up text-center">
                                    <h5 class="title text-center text-blue">FREE UP TO</h5>
                                    <p class="text-center mt-0">+100 GB Storage</p>
                                    <p class="text-center mt-0">+4GB Memory</p>
                                    <p class="text-center mt-0">+1IP Public</p>
                                </div>
                                <div class="price text-center mt-3">
                                    <s>
                                        <p class="price-normal">Rp 2,5 JT</p>
                                    </s>
                                    <h4 class="promo text-blue">Rp. 1.800.000</h4>
                                </div>
                            </div>
                        </div>
                    </div>
